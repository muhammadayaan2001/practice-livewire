        ...
        <form wire:submit.prevent="update">
            <h2 class="display-6 mb-3">Update Employee</h2>
            ...
            <div class="row g-2">
                ...
                <div class="col-md mb-3">
                    ...
                    <div class="form-floating">
                        <select class="form-select" wire:model="gender" id="floatingSelectGrid" aria-label="Floating label select example">
                            <option value="">Select Gender</option>
                            @foreach($genders as $genderOption)
                                <option value="{{ $genderOption }}" {{ $gender == $genderOption ? 'selected' : '' }}>
